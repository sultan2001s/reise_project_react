            ...
            <div className="container">
                <div className="footer__content">
                    <ul className="footer__list">
                        ...
                        <li className="footer__number"><a className="footer__num" href="https://web.whatsapp.com/">0709 975-311</a><a href="https://web.whatsapp.com/"><ImWhatsapp className="footer__icons"/></a> </li>
                    ...
                    <ul className="footer__list">
                        ...
                        <li className="footer__number"><a className="footer__num" href="https://web.whatsapp.com/">0509 975-311</a><a href="https://web.whatsapp.com/"><ImWhatsapp className="footer__icons"/></a> </li>
