                ...
                <div className="container">
                    <div className="courses__content">
                        <div className="courses__left">
                            <h2 className="courses__title">Курсы немецкого языка от <span style={{color: "#FE0000"}}>Reise</span></h2>
                        ...
                        <ul className="courses__icons" >
                            ...
                            <ul>
                                <li className="courses__icon" style={{display: 'flex', alignItems: 'center', columnGap: '9px'}}><RiRoadMapFill className="main__icon"/><a className="courses__icon" href="https://go.2gis.com/gbqggj">ул.Ахунбаева 110а </a></li>
