                ...
                <div className="container">
                    <div className="courses__content">
                        ...
                        <ul className="main__icons">
                            ...
                            <ul>
                                <li className="main__number"><a href="tel:+996 779 975 311" className="main__icon">+996 779 975 311</a></li>
                                <li className="main__number"><a href="tel:+996 559 975 311" className="main__icon">+996 559 975 311</a></li>
                                <li className="main__number"><a href="https://wa.me/+996709975311" className="main__icon">+996 709 975 311 <ImWhatsapp/></a></li>
                            </ul>
                            ...
                            <ul>
                                <li className="main__number"><a href="tel:+996 999 975 311" className="main__icon">+996 999 975 311</a></li>
                                <li className="main__number"><a href="tel:+996 222 975 311" className="main__icon">+996 222 975 311</a></li>
                                <li className="main__number"><a className="main__icon" href="https://wa.me/+996509975311">+996 509 975 311 <ImWhatsapp/></a></li>   
                            </ul>
                        </ul>
                    </div>
                </div>
